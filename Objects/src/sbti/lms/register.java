...
public class register extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "sbti.lms", "sbti.lms.register");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "sbti.lms", "sbti.lms.register");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "sbti.lms.register", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public anywheresoftware.b4a.objects.EditTextWrapper _txtempid = null;
...
mostCurrent._txtemail = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Private txtEmpID As EditText";
mostCurrent._txtempid = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Private txtFullname As EditText";
mostCurrent._txtfullname = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Private txtGender As EditText";
mostCurrent._txtgender = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Private txtPassword As EditText";
mostCurrent._txtpassword = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Private txtRole As EditText";
mostCurrent._txtrole = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 24;BA.debugLine="End Sub";
return "";
}
public static String  _hideinputline() throws Exception{
 //BA.debugLineNum = 41;BA.debugLine="Sub HideInputLine";
 //BA.debugLineNum = 42;BA.debugLine="txtEmpID.Color = Colors.Transparent";
mostCurrent._txtempid.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 43;BA.debugLine="txtFullname.Color = Colors.Transparent";
mostCurrent._txtfullname.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 44;BA.debugLine="txtEmail.Color = Colors.Transparent";
mostCurrent._txtemail.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 45;BA.debugLine="txtGender.Color = Colors.Transparent";
mostCurrent._txtgender.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 46;BA.debugLine="txtRole.Color = Colors.Transparent";
mostCurrent._txtrole.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 47;BA.debugLine="txtPassword.Color = Colors.Transparent";
...
public static String  _txtpassword_enterpressed() throws Exception{
 //BA.debugLineNum = 51;BA.debugLine="Private Sub txtPassword_EnterPressed";
